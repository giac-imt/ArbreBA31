...
public class Main {
    public static void main(String[] args) {
        ...
        while ( n<2)
        {
            ...
            n=input.nextInt();//  User inputs the ordre of Tree and is assinged to N.
        }
        Arbre tree = new Arbre(n);//  B-Tree Tree with ordre  N is created.
            ...
            else
            {
                switch(choice)
                {
                    ...
                    case 3: //If the User Enters 3 this case is executed and
                        ...
                        System.out.println("What is the key you wish to rechercheNoeud for:");
                        int key2=input.nextInt();
                        System.out.println(tree.rechercherValeur(tree,key2));
